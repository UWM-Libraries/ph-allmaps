...
export function parse() {
    const command = addAnnotationInputOptions(new Command('parse')
        .argument('[files...]')
        .summary('parse Georeference Annotation')
        .description("Parse and validate Georeference Annotations to Georeferenced Maps - Allmaps' internal map format"));

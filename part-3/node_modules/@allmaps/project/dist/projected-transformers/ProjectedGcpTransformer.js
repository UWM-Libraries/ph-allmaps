...
import { defaultProjectedGcpTransformerOptions, isEqualProjection, lonLatProjection } from '../shared/project-functions.js';
/**
...
export class ProjectedGcpTransformer extends GcpTransformer {
     ...
     * @returns this
     */
    static setProjection(projectedTransformer, projection) {
        if (isEqualProjection(projection, projectedTransformer.projection)) {
            return projectedTransformer;
        }
        const internalProjectionToProjectionConverter = proj4(projectedTransformer.internalProjection.definition, projection.definition);
        const postToGeo = internalProjectionToProjectionConverter.forward;
        const preToResource = internalProjectionToProjectionConverter.inverse;
        ...
        projectedTransformer.setTransformerOptionsInternal(partialGcpTransformerOptions);

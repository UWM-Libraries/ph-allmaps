...
export type AttachedTransformationFromGeoreferencedMapOptions = TransformationTypeInputs & {
...
export type AttachedTransformationOptions = AttachedTransformationFromGeoreferencedMapOptions & {
    averageOut: boolean;
};
export type Rcp = {
    type: 'rcp';

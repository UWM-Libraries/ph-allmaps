...
import type { LanguageString, Metadata, MajorVersion, FetchNextItemResults, NavDate, NavPlace, Thumbnail, SeeAlso, Summary, RequiredStatement, Annotations, Homepage, Rendering, ConstructorOptions, ParseOptions } from '../lib/types.js';
...
export declare class Manifest extends EmbeddedManifest {
    ...
    constructor(parsedManifest: ManifestType, options?: Partial<ConstructorOptions>);
    /**
     ...
     */
    static parse(iiifManifest: unknown, options?: Partial<ParseOptions>): Manifest;
    get images(): (EmbeddedImage | Image)[];
    fetchAllItems(fetchFn?: typeof fetch): Promise<FetchNextItemResults<Image>[]>;
    fetchNextItem(fetchFn?: typeof fetch, depth?: number): AsyncGenerator<FetchNextItemResults<Image>, void, void>;
